...
#[deprecated(note = "Jupiter deprecated `route`. Use `JUP_V6_ROUTE_V2_DISC`.")]
...
#[deprecated(
    note = "Jupiter deprecated `shared_accounts_route`. Use `JUP_V6_SHARED_ACCOUNT_ROUTE_V2_DISC`."
)]
pub const JUP_V6_SHARED_ACCOUNT_ROUTE_DISC: [u8; 8] = [193, 32, 155, 51, 65, 214, 156, 129];
// https://github.com/MeteoraAg/zap-program/blob/4b67bfc64e5a023a1b74386be8b82c3908934a0b/idls/jupiter.json#L373
pub const JUP_V6_ROUTE_V2_DISC: [u8; 8] = [187, 100, 250, 204, 49, 196, 175, 20];
// https://github.com/MeteoraAg/zap-program/blob/4b67bfc64e5a023a1b74386be8b82c3908934a0b/idls/jupiter.json#L442
pub const JUP_V6_SHARED_ACCOUNT_ROUTE_V2_DISC: [u8; 8] = [209, 152, 83, 147, 124, 254, 216, 233];
