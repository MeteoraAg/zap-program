...
pub trait SafeMath<T>: Sized {
    ...
    fn safe_mul(self, rhs: Self) -> Result<Self, ZapError>;
    fn safe_div(self, rhs: Self) -> Result<Self, ZapError>;
    fn safe_rem(self, rhs: Self) -> Result<Self, ZapError>;
    fn safe_sub(self, rhs: Self) -> Result<Self, ZapError>;
    fn safe_shl(self, offset: T) -> Result<Self, ZapError>;
    fn safe_shr(self, offset: T) -> Result<Self, ZapError>;
}
